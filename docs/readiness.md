...
- `services/base/authentik/values.yaml` disables bundled PostgreSQL, mounts the CNPG CA Secret, uses PostgreSQL TLS verification, keeps chart service account creation enabled, and configures the public/internal ingress names.
