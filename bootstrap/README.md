...
Prometheus, Grafana, Alertmanager, Loki, or any metrics/log persistence. Monitor
objects can exist before the runtime stack; they are just inert until Prometheus
is deployed.
